...
#ifndef MODEL_PARAMETER_HPP_
#define MODEL_PARAMETER_HPP_
...
namespace LQCDA {
    ...
    public:
		ModelParameter(unsigned int num, const std::string& name) :
		    ModelParameter(num, name, 0.)
		    {}
		ModelParameter(unsigned int num, const std::string& name, double val) :
		    FunctionParameter(num, name, val, 0.)
		    {}
		ModelParameter(unsigned int num, const std::string& name, double val, double err) :
		    _NumberId(num),
		    _Name(name),
		    _Value(val),
		    _Error(err),
		    ...
		    {}
		ModelParameter(unsigned int num, const std::string& name, double val, double err, double min, double max) :
		    _NumberId(num),
		    _Name(name),
		    _Value(val),
		    _Error(err),
